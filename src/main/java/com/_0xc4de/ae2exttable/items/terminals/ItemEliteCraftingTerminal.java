...
public class ItemEliteCraftingTerminal extends Item implements IPartItem {

    public ItemEliteCraftingTerminal(String name) {
    ...
    public @Nullable IPart createPartFromItemStack(ItemStack stack) {
        return new PartEliteCraftingTerminal(stack);
    }
    ...
    public void initModel() {
        AEApi.instance().registries().partModels().registerModels(PartEliteCraftingTerminal.resources);
    }
}
