/**
 * Original Author: @PrototypeTrousers
...
public class JEIMissingItem implements IRecipeTransferError {
    ...
    JEIMissingItem(Container container, @Nonnull IRecipeLayout recipeLayout) {
        if (container instanceof ContainerMEMonitorableTwo) {
            IItemList<IAEItemStack> ir = ((ContainerMEMonitorableTwo) container).items;

            IItemList<IAEItemStack> available = mergeInventories(ir, (ContainerMEMonitorableTwo) container);
    ...
    public void showError(Minecraft minecraft, int mouseX, int mouseY, @Nonnull IRecipeLayout recipeLayout, int recipeX, int recipeY) {
        ...
        if (c instanceof ContainerMEMonitorableTwo container) {
    ...
    IItemList<IAEItemStack> mergeInventories(IItemList<IAEItemStack> repo, ContainerMEMonitorableTwo containerCraftingTerm) {
