...
public class ItemRegistry {
    public static void init() {
        ...
        registry.register(new ItemEliteCraftingTerminal("elite_crafting_terminal"), "elite_crafting_terminal");
        registry.register(new ItemUltimateCraftingTerminal("ultimate_crafting_terminal"), "ultimate_crafting_terminal");
