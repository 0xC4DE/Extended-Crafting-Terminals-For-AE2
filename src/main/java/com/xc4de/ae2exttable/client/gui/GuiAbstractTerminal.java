...
public abstract class GuiAbstractTerminal extends AEBaseMEGui implements ISortSource, IConfigManagerHost {
    ...
    public GuiAbstractTerminal(final InventoryPlayer inventoryPlayer, final ITerminalHost te) {
        this(inventoryPlayer, te, new ContainerMEMonitorable(inventoryPlayer, te));
    }

    public GuiAbstractTerminal(final InventoryPlayer inventoryPlayer, final ITerminalHost te, final ContainerMEMonitorable c) {
