...
public class PartAdvancedCraftingTerminal extends PartSharedCraftingTerminal implements
    ITerminalGui {
    ...
    public static ResourceLocation[] resources = new ResourceLocation[] {
            ...
            new ResourceLocation(Tags.MODID, "part/advanced_on"), // MODEL_ON
            new ResourceLocation(Tags.MODID, "part/advanced_off"), // MODEL_OFF
    ...
    public PartAdvancedCraftingTerminal(final ItemStack is) {
        super(is, AE2ExtendedGUIs.ADVANCED_CRAFTING_TERMINAL);
    }
